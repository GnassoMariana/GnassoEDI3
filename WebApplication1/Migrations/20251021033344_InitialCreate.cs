        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TrabajadorActivo = table.Column<bool>(type: "bit", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_RegistroAsistencias_Empleados_EmpleadoId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    HorasTotales = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    SueldoFinal = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    PremioAsistencia = table.Column<bool>(type: "bit", nullable: false),
                    DiasAusencias = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ReportesMensuales_Empleados_EmpleadoId",
                        column: x => x.EmpleadoId,
                        principalTable: "Empleados",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_RegistroAsistencias_EmpleadoId",
                table: "RegistroAsistencias",
                column: "EmpleadoId");

            migrationBuilder.CreateIndex(
                name: "IX_ReportesMensuales_EmpleadoId",
