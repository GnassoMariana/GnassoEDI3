...
namespace GnassoEDI3.Services.AuthServices
{
    ...
    {
        string GenerateJwtTokens(ITokenParametros parametros);
    }

    public class TokenServices : ITokenHandlerService
    {
        private readonly JwtConfig _jwtConfig;
        public TokenServices(IOptionsMonitor<JwtConfig> optionsMonitor)
        {
            _jwtConfig = optionsMonitor.CurrentValue;

        }
        public string GenerateJwtTokens(ITokenParametros parametros)
        {
